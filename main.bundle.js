...
module.exports = "<div class=\"container-fluid\">\n  <br>\n  <h6 routerLink=\"\">go to home </h6>\n  <br>\n\n  <div class=\"panel panel-default\">\n    <div class=\"panel-body\">\n      <div class=\"col-md-12\">\n        <div class=\"row\">\n          <div class=\"col-md-4\">\n            <h5>Goals list</h5>\n            <table class=\"table table-bordered\">\n              <tr *ngFor=\"let goal of goals; let i = index\" (click)=removeItem(i)>\n                <td> <b>{{ i+1 }}</b> </td>\n                <td> <b>{{ goal }}</b> </td>\n              </tr>\n            </table>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
var AboutComponent = /** @class */ (function () {
    function AboutComponent(route, _data) {
        this.route = route;
        this._data = _data;
...
var routes = [
    ...
    { path: 'about/:id', component: __WEBPACK_IMPORTED_MODULE_3__about_about_component__["a" /* AboutComponent */] }
];
...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<div class=\"col-md-12 brand-header\">\n  <h3 class=\"text-center\">TIMES OF INDIA</h3>\n</div>\n<app-header> </app-header>\n<router-outlet></router-outlet>\n"
...
// module
exports.push([module.i, ".brand-header {\n  background: black;\n  padding: 10px 10px 5px 10px; }\n  .brand-header h3 {\n    color: #FFF;\n    font-family: serif;\n    font-size: 32px; }\n", ""]);
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.goals = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](['this is initial goal', 'another goal']);
...
module.exports = "<ul>\n  <li>\n    <a routerLink=\"\">Home</a>\n    <a routerLink=\"\">City</a>\n    <a routerLink=\"\">India</a>\n    <a routerLink=\"\">World</a>\n    <a routerLink=\"\">Business</a>\n    <a routerLink=\"\">Entertainment</a>\n    <a routerLink=\"about/48\">About</a>\n  </li>\n</ul>\n"
...
module.exports = "<div class=\"container-fluid\">\n  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\">\n      <div class=\"col-md-12\">\n        <h4>Home page</h4>\n      </div>\n    </div>\n    <div class=\"panel-body\">\n      <div class=\"col-md-12\">\n        <div class=\"row\" [@goals]=\"goals.length\">\n          <div class=\"col-md-4\">\n            <h5>Add Goals</h5>\n            <form class=\"\">\n              <div class=\"input-group\">\n                <input type=\"text\" name=\"item\" class=\"form-control\" [(ngModel)]=\"goalText\">\n                <button type=\"submit\" class=\"btn btn-sm btn-success\" name=\"button\" (click)=\"addItem()\">{{ btnText }}</button>\n                <!-- <p *ngIf=\"warningFlag\" class=\"text-danger\">please enter goal..!</p> -->\n              </div>\n            </form>\n          </div>\n          <div class=\"col-md-4\">\n            <h5>Goals list ( {{ itemCount }} )</h5>\n            <table class=\"table table-bordered\">\n              <tr *ngFor=\"let goal of goals; let i = index\" (click)=removeItem(i)>\n                <td> <b>{{ i+1 }}</b> </td>\n                <td> <b>{{ goal }}</b> </td>\n              </tr>\n            </table>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"clearfix\" *ngFor=\"let news of newses; let i = index\">\n    <div class=\"panel panel-default\">\n      <div class=\"panel-heading\">\n        <div class=\"col-md-12\">\n          <h4>News title {{i+1}}</h4>\n        </div>\n      </div>\n      <div class=\"panel-body\">\n        <div class=\"col-md-12\">\n          <div class=\"row\">\n            <div class=\"col-md-4\">\n              <h5>news content 1</h5>\n            </div>\n            <div class=\"col-md-4\">\n              <h5>news content 2</h5>\n            </div>\n            <div class=\"col-md-4\">\n              <h5>news content 3</h5>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n\n  </div>\n</div>\n"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_data) {
        ...
        this.goalText = 'This is my first goal';
        this.goals = [];
        this.newses = [1, 2, 3];
    }
